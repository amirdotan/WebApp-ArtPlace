...
export default function RecipeReviewCard() {
  ...
  useEffect(() => {
    const getProfile = async () => {
      const usersDocRef = doc(db, "users", "user_"+profileId);
      ...
      <Card sx={{ maxWidth: 345 }} class="addportfoliocard">
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            {profileDb.first_name + ' ' + profileDb.last_name} didin't upload a portfolio yet :(
          </Typography>
        </CardContent>
    <Button variant="contained" onClick={() => navigate("/UploadPortfolio") } sx={{}} >Get in touch</Button>
      </Card>
